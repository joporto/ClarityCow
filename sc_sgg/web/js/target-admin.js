var target_admin = function () {
  ...
  function init () {    
	...
	//Editado por Rafael Vásquez 01-08-2015
	$('.borrar').off().click(function(e) {
		e.preventDefault();
        var url = $(this).attr('href');
		bootbox.confirm("¿Esta seguro de borrar este elemento?", function(result) {
		  if(result)
		  	window.location = url;
		}); 
	...
	$('.pagination li a.active').parent('li').addClass('active');
  }
